...
public class AllPrevQuesPaper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_prev_ques_paper);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), AddPrevQuesPaper.class).putExtra("subject",subject));
    ...
    protected void onStart() {
        super.onStart();
        new GetAllQPaper().execute();

    }

    private class GetAllQPaper extends AsyncTask<Void,Void,Void> {
        @Override
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            if(response.has("res"))
                            {
                                try {
                                    ...
                                    {
                                        titleList.add(arr.getJSONObject(i).getString("year"));
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            ...
                            {
                                Toast.makeText(getBaseContext(),"No Question paper Added",Toast.LENGTH_SHORT).show();
                            }
                            Collections.reverse(titleList);
                            ArrayAdapter adapter = new ArrayAdapter<String>(AllPrevQuesPaper.this,
